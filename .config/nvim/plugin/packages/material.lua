...
material.setup({
  ...
  custom_highlights = {
    ...
    CmpItemAbbrDeprecated = { fg = colors.comments, bold = true },
    ...
    CmpItemKindCopilot = { fg = colors.red },
    ...
    jsCatch = { fg = colors.cyan, italic = true },
    ...
    jsConditional = { fg = colors.cyan, italic = true },
    jsDocParam = { fg = colors.green },
    jsDocTags = { fg = colors.cyan },
    jsDot = { fg = colors.cyan },
    jsException = { fg = colors.cyan, italic = true },
    jsExceptions = { fg = colors.yellow },
    jsExport = { fg = colors.cyan, italic = true },
    jsExportDefault = { fg = colors.cyan, italic = true },
    jsExtendsKeyword = { fg = colors.purple },
    jsFinally = { fg = colors.cyan, italic = true },
    jsFinallyBraces = { fg = colors.cyan },
    jsFlowArgumentDef = { fg = colors.yellow },
    jsForAwait = { fg = colors.cyan, italic = true },
    jsFrom = { fg = colors.cyan, italic = true },
    ...
    jsImport = { fg = colors.cyan, italic = true },
    jsModuleAs = { fg = colors.cyan, italic = true },
    ...
    jsRepeat = { fg = colors.cyan, italic = true },
    jsReturn = { fg = colors.cyan, italic = true },
    ...
    jsThis = { fg = colors.cyan, italic = true },
    jsTry = { fg = colors.cyan, italic = true },
    ...
    jsxAttrib = { fg = colors.purple, italic = true },
    ...
    htmlArg = { fg = colors.purple, italic = true },
    htmlTitle = { fg = colors.fg },
    htmlLink = { fg = colors.fg },
    htmlBold = { fg = colors.pink, bold = true },
    ...
    -- XML
    xmlAttrib = { fg = colors.purple, italic = true },
    xmlEndTag = { fg = colors.cyan },
    xmlTag = { fg = colors.cyan },
    xmlTagName = { fg = colors.pink },

    -- Markdown
    markdownBold = { fg = colors.pink, bold = true },
    ...
    mkdURL = { fg = colors.pink, underline = true },
  },
})
