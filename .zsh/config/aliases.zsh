...
alias c-mac="$EDITOR +'cd ~/.config/macos/' ~/.config/macos/"
alias c-mailcap="$EDITOR +'cd ~/.mutt/' ~/.mutt/mailcap"
alias c-mpv="$EDITOR +'cd ~/.config/mpv/' ~/.config/mpv/"
alias c-msmtp="$EDITOR +'cd ~/.mutt/' ~/.mutt/msmtprc"
alias c-mutt="$EDITOR +'cd ~/.mutt/' ~/.mutt/muttrc"
alias c-newsboat="$EDITOR +'cd ~/.newsboat/' ~/.newsboat/"
...
alias c-tmux="$EDITOR +'cd ~/.tmux/' ~/.tmux/"
alias c-transmission="$EDITOR +'cd ~/.config/transmission/' ~/.config/transmission/"
