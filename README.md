<img width="100" height="114" alt="Project logo" src="https://github.com/user-attachments/assets/c0b1bc45-de86-4564-819f-d78fb488c038" />
    ...
    <tr>
      <td colspan="2">
        <img
          ...
          src="https://github.com/user-attachments/assets/6f080622-fba4-4cbf-9c3e-4f34dba99823"
        />
      </td>
    </tr>
    <tr>
      <td>
        <img
          ...
          height="1191"
          alt="yazi screenshot"
          src="https://github.com/user-attachments/assets/e643591a-6e47-4433-8d10-5d69c3a85576"
        />
      </td>
      <td>
        <img
          ...
          height="1191"
          alt="zsh screenshot"
          src="https://github.com/user-attachments/assets/0b54ca81-2181-4fa0-a5bc-e106509773a2"
        />
      </td>
    </tr>
    <tr>
      <td>
        <img
          ...
          src="https://github.com/user-attachments/assets/57acde0a-2b5a-40c8-b9bb-9e04bcc968f3"
        />
      </td>
      <td>
        <img
          ...
          src="https://github.com/user-attachments/assets/82d31b3a-1bee-4348-a392-bcffd320e1d8"
        />
      </td>
    </tr>
  </tbody>
...
- [`yazi`](https://github.com/catppuccin/yazi) - Terminal file manager with vim-like key bindings
...
- [`docker`](https://github.com/docker/cli) - Pack, ship and run any application as a lightweight container
- [`dive`](https://github.com/wagoodman/dive) - A tool for exploring each layer in a docker image
- [`trash-cli`](https://github.com/sindresorhus/trash-cli) - Safe `rm` alternative, move files and folders to the trash
- [`fd`](https://github.com/sharkdp/fd) - Simple, fast and user-friendly alternative to `find`
- [`gh`](https://github.com/cli/cli) - CLI tool for interacting with GitHub from the command line
- [`lazydocker`](https://github.com/jesseduffield/lazydocker) - TUI for managing Docker containers and images
- [`massren`](https://github.com/laurent22/massren) - Command-line tool for mass renaming files and directories
