...
function! kutsan#commands#registers() abort
	...
	syntax match registersType /^[A-Za-z-]*/ contained
	syntax match registersTypeColon /^[A-Za-z-]*:/ contains=registersType
	highlight default link registersType Title
	highlight default link registersTypeColon NonText

	syntax match registersToken /^ ./ contained
	syntax match registersTokenColon /^ .:/ contains=registersToken
