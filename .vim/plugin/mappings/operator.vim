...
nnoremap <silent> gc* :set operatorfunc=kutsan#mappings#operator#search#<Enter>g@
xnoremap <silent> gc* :<C-u>call kutsan#mappings#operator#search#(visualmode())<Enter>
